...
<CardGroup cols={2}>
  <Card title="Configuration" icon="gear" href="/configuration/settings">
    Configure token expiration, CORS, and other settings
  </Card>
  ...
  <Card title="Examples" icon="code-branch" href="/examples/react">
    View integration examples for popular frameworks
  </Card>
</CardGroup>
