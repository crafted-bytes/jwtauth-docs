...
<CardGroup cols={2}>
  ...
  <Card title="Security Suite" icon="shield-check">
    Rate limiting, IP tracking, and automatic token revocation on security events
  </Card>
  <Card title="Analytics Dashboard" icon="chart-line">
    Real-time monitoring of token usage, API requests, and security events
  </Card>
</CardGroup>
